	...
	return (
		<div className="mt-8 w-full lg:my-16 lg:mb-32 lg:p-8 ">
			<form
				...
				<label className="text-md border-2  p-4 rounded-md  font-bold lg:text-2xl">
					<img
					...
					<span className="block font-medium text-xs lg:lg:text-2xl mb-4 py-4 lg:w-3/4">
