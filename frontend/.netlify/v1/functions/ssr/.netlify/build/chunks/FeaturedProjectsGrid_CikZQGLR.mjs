import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent } from './astro/server_DpFPBP4F.mjs';
import 'kleur/colors';
...
const ProjectCard = ({ project }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "lowercase flex flex-col items-center lg:p-20", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(
            "video",
            {
              ...
              src: project.thumbnail_url ? project.thumbnail_url : "https://iiyjiikbtsckevydbcsj.supabase.co/storage/v1/object/public/website-assets/branding/logos/SPAP%20Logos/Icon/PNG/Black_Icon%20Lockup_SPAP.png"
            }
          ),
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-2 py-4", children: [
      /* @__PURE__ */ jsx("p", { className: "font-semibold text-background-primary text-xl lg:text-4xl", children: project.project_name }),
