...
import 'kleur/colors';
import { c as cn, B as Button, $ as $$RootLayout } from '../chunks/RootLayout_CLCoi8gq.mjs';
import { jsxs, jsx } from 'react/jsx-runtime';
import * as React from 'react';
import React__default from 'react';
import { I as Input } from '../chunks/input_BWNmnRZi.mjs';
...
function TestimonialForm(props) {
  const [ratingValue, setRatingValue] = React__default.useState(5);
  ...
  return /* @__PURE__ */ jsxs(
    "form",
    {
      ...
      className: "bg-white p-10 lg:p-20 rounded-xl font-medium space-y-4",
      children: [
