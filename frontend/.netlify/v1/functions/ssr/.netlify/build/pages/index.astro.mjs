import { a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent } from '../chunks/astro/server_DfnRGx3A.mjs';
import 'kleur/colors';
import { $ as $$RootLayout } from '../chunks/RootLayout_DA6riOg4.mjs';
import { $ as $$SocialMediaButtonGroup } from '../chunks/SocialMediaButtonGroup_Cz7zmpsh.mjs';
import 'clsx';
...
const ServicesContainer = () => {
  return /* @__PURE__ */ jsx(motion.div, { className: "flex md:flex-wrap flex-col md:flex-row items-center justify-center gap-4 mx-auto", children: services.map((service, idx) => /* @__PURE__ */ jsxs(
    motion.div,
    {
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(["", ' <script type="text/javascript" async src="https://embeds.beehiiv.com/attribution.js"><\/script>'])), renderComponent($$result, "RootLayout", $$RootLayout, { "title": "Amplified Web Presence for Creative Entrepreneurs", "description": "SPAP Technology Solutions specializes in crafting solutions for creative entrepreneurs including website development, app development,business tools, integrations, copywriting, and more.", "imageRef": "https://iiyjiikbtsckevydbcsj.supabase.co/storage/v1/object/public/website-assets/branding/logos/SPAP%20Logos/Vertical/PNG/White_Vertical%20Lockup_SPAP.png", "urlSlug": "/" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section id="hero" class="relative h-screen w-screen rounded-xl"> <video class="absolute top-1/2 left-1/2 w-full h-full object-cover transform -translate-x-1/2 -translate-y-1/2 z-10" src="https://iiyjiikbtsckevydbcsj.supabase.co/storage/v1/object/public/website-assets/media/video/Black%20Video%201920x1080.mp4?t=2024-11-15T06%3A35%3A09.659Z" autoplay muted loop playsinline></video> <!-- Content on top of the video --> <div id="content-container" class="relative z-20 bg-black/25 flex flex-col items-center justify-center py-10 text-white h-full"> <h1 class="text-7xl font-semibold md:text-[8rem] text-center order-1 lowercase">
Shawn Paps
</h1> <h2>Web Developer | Web Designer | Data Management</h2> <div class="order-3"> ${renderComponent($$result2, "SocialMediaButtonGroup", $$SocialMediaButtonGroup, { "color": "text-primary" })} </div> <p class=" pb-8 font-bold text-xl text-center order-2 md:text-5xl lowercase">
