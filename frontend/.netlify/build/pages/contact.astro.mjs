...
const ContactForm = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "mt-8 w-full lg:my-16 lg:mb-32  ", children: /* @__PURE__ */ jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("label", { className: "text-2xl", children: [
          "First Name",
          /* @__PURE__ */ jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsxs("label", { className: "text-md border-2  p-4 rounded-md  font-bold text-2xl", children: [
          /* @__PURE__ */ jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxs("span", { className: "block font-medium text-xs lg:text-2xl mb-4 py-4 lg:w-3/4", children: [
