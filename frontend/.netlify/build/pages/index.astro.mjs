import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, d as renderComponent } from '../chunks/astro/server_DpFPBP4F.mjs';
import 'kleur/colors';
import { $ as $$RootLayout } from '../chunks/RootLayout_CSHR_Wd4.mjs';
import { b as $$SocialMediaButtonGroup, d as $$SocialMediaButton } from '../chunks/NavigationContainer_3eZbIG55.mjs';
/* empty css                                     */
import { $ as $$FeaturedProjectsGrid } from '../chunks/FeaturedProjectsGrid_CikZQGLR.mjs';
import 'clsx';
...
const ServicesContainer = () => {
  return /* @__PURE__ */ jsx(motion.div, { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 p-2 lg:w-3/4 lg:p-20 ", children: services.map((service, idx) => /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-2xl lg:text-5xl lg:py-2 font-bold lowercase bg-gradient-to-r from-accent-primary to-accent-pop bg-clip-text text-transparent", children: service.name }),
