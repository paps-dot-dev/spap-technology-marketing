import { c as createComponent, r as renderTemplate, d as renderComponent, b as createAstro, m as maybeRenderHead } from '../../chunks/astro/server_DpFPBP4F.mjs';
import 'kleur/colors';
import { $ as $$RootLayout } from '../../chunks/RootLayout_CSHR_Wd4.mjs';
import { jsxs, jsx } from 'react/jsx-runtime';
import React__default from 'react';
import { I as Input } from '../../chunks/input_CAo1rLww.mjs';
import { B as Button } from '../../chunks/NavigationContainer_3eZbIG55.mjs';
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleFormSubmit, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-4 shadow-xl", children: [
        /* @__PURE__ */ jsxs("label", { id: "name", className: "text-sm", children: [
          "Referral Name:",
          /* @__PURE__ */ jsx(Input, { required: true, onChange: onReferralChange, id: "name", value: referralData.name })
        ] }),
        /* @__PURE__ */ jsxs("label", { className: "text-sm", children: [
          "Referral Email:",
          /* @__PURE__ */ jsx(Input, { required: true, onChange: onReferralChange, id: "email", value: referralData.email })
        ] }),
        /* @__PURE__ */ jsx(Button, { type: "submit", className: "bg-accent-pop mt-4", children: "Add" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "my-4", children: formData.referrals.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "p-8 my-4 shadow-sm rounded-xl border-2 border-background-primary", children: [
